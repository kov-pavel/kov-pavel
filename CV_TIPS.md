...
В классическом сценарии резюме должно занимать 1-2 страницы (1 - идеал, но если есть много опыта, то можно и на 2 растянуть). 
...
(например - **Junior Java Software Developer**). [Про разницу грейдов](https://habr.com/ru/companies/ratingruneta/articles/763566/).
...
6) все контакты должны быть представлены в **нейтральном**, **деловом** стиле
   ...
   - моя почта тоже не слишком *деловая*: **paaavel.2024@gmail.com**, рекомендуется зарегистрировать новую почту под более деловым названием
     ...
     Более того, так получится разграничить рабочую часть и остальную жизнь, что, вообще говоря, является важной компонентной здорового образа жизни
      и впоследствии уже на работе это сильно поможет не мешать все в кучу, оставлять работе рабочее время, а личным делам - оставшееся.
   - для этого может потребоваться **новый номер телефона**, что сопряжено с возможностью телефону иметь внутри себя эти 2 симкарты для доступа к разным аккаунтам.
   - при этом если в оставляемых контактах присутствует аватар, то он должен быть приличным,
     а если аккаунта 2 в одном и том же типе связи, то дублирующуюсю фотографию надо как-то выделить на фоне первой, личной (добавить размытие, текст "work" и тд)
...
Структура - такая же, как и в [Опыт](#Опыт).
...
По сути - аккумуляция *стека технологий* из разделов [Образование](#Образование) и [Опыт](#Опыт), только тут упор делается на том, что действительно изучено в деталях и готово к применению в любой момент.
...
### Выделение текста
В идеале резюме должно быть лаконичным настолько, насколько это возможно. Однако есть разделы с описанием того, какие проблемы решались и какого рода задачи вообще решались в разных проектах.
...
2) [мое CV](https://disk.yandex.ru/i/n1fmNzXrXmoIBw)
